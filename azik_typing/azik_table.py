...
KANA_TO_AZIK: dict[str, str] = {
    ...
    "ちゃ": "ca",  "ちゅ": "cu",  "ちょ": "co",   # c形が最短 (ty形より1打短い)
    ...
    "ちょう": "cp",  "ちょん": "cl",  "ちゅん": "cj",  "ちゅう": "ch",  "ちゃん": "cz",  "ちゃい": "cq",
    ...
    "ぢん": "dk",
    # て行拡張
    "てぃ": "tgi", "てぃん": "tgk", "てゅ": "tgu",
    # つ行拡張
    "つぁ": "tsa", "つぇ": "tse", "つぃ": "tsi", "つぉ": "tso",
    # ふ行拡張
    "ふぁん": "fn", "ふぁい": "fq", "ふぇん": "fd", "ふぇい": "fw",
    "ふぃん": "fk", "ふぉん": "fl", "ふむ": "fm", "ふる": "fr",
    # き行拡張
    "きぇ": "kge", "きぇん": "kgd", "きぇい": "kgw",
    # ひ行拡張
    "ひぇ": "hge", "ひぇん": "hgd", "ひぇい": "hgw",
    # み行拡張
    "みぇ": "mge", "みぇん": "mgd", "みぇい": "mgw",
    # に行拡張
    "にぇ": "nge", "にぇん": "ngd", "にぇい": "ngw",
    # ぎ行拡張
    "ぎぇん": "gyd", "ぎぇい": "gyw",
    # び行拡張
    "びぇん": "byd", "びぇい": "byw",
    # ぴ行拡張
    "ぴぇ": "pge", "ぴぇん": "pgd", "ぴぇい": "pgw",
    # じ行拡張
    "じぇん": "jd", "じぇい": "jw",
    # り行拡張
    "りぇん": "ryd", "りぇい": "ryw",
    ...
    "ばら": "br", "まる": "mr", "である": "dr", "だが": "dg", "しも": "sm",
    "りょく": "ryk",
...
STROKE_VARIANTS: dict[str, list[str]] = {
    ...
    # f-suffix shortcuts (alternative inputs, ergonomic)
    "ki": ["kf"],   # き: kf alternative
    "mu": ["mf"],   # む: mf alternative
    "nu": ["nf"],   # ぬ: nf alternative
    "yu": ["yf"],   # ゆ: yf alternative
    "de": ["df"],   # で: df alternative
    "ze": ["zf"],   # ぜ: zf alternative

    # n-suffix aliases (n and z are both valid for A段 ん)
    "kz": ["kn"],  "sz": ["sn"],  "tz": ["tn"],  "dz": ["dn"],
    "gz": ["gn"],  "rz": ["rn"],  "zz": ["zn"],  "hz": ["hn"],
    "pz": ["pn"],  "wz": ["wn"],  "yz": ["yn"],
